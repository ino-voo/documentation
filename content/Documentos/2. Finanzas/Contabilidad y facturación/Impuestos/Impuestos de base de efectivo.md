...
## Configuración[](https://www.odoo.com/documentation/17.0/es/applications/finance/accounting/taxes/cash_basis.html#configuration "Enlazar permanentemente con este título")

Vaya a Contabilidad ‣ Configuración ‣ Ajustes y habilite la opción base de efectivo en la sección impuestos.
...
![Seleccione del diario de base de impuestos en efectivo y haga clic en el enlace externo.](https://www.odoo.com/documentation/17.0/es/_images/tax_cash_basis_journal.png)
...
Una vez hecho esto, vaya a Contabilidad ‣ Configuración ‣ Contabilidad: Impuestos para configurar sus impuestos. Puede crear un nuevo impuesto o actualizar uno existente al hacer clic en él.

La columna cuenta refleja las cuentas transicionales adecuadas para registrar impuestos hasta que se registre el pago.

![Complete la columna "cuenta" con una cuenta transicional en la que colocar los impuestos hasta que se registre el pago.](https://www.odoo.com/documentation/17.0/es/_images/account_column.png)
...
![Completar la cuenta de transición de base de efectivo en la que se almacenarán los importes de impuestos hasta la conciliación del pago.](https://www.odoo.com/documentation/17.0/es/_images/advanced_options.png)

## Impacto de los impuestos de base de efectivo en la contabilidad[](https://www.odoo.com/documentation/17.0/es/applications/finance/accounting/taxes/cash_basis.html#impact-of-cash-basis-taxes-on-accounting "Enlazar permanentemente con este título")
...
![](https://www.odoo.com/documentation/17.0/es/_images/customer_invoice_with_cbt.png)
...
Se recomienda utilizar una cuenta de base de impuestos recibidos para que su balance sea cero y su cuenta de ingresos no se vea afectada por movimientos contables innecesarios. Para hacerlo, vaya a Configuración ‣ Ajustes ‣ Impuestos y seleccione una cuenta de base de impuestos recibidos en base de efectivo.